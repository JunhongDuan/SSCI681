...
for (year in 2010:2019){
  ...
  MYB_yearly_data <- MYB_yearly_data %>%
    mutate(
           year = year,
           B25035_001E = ifelse(B25035_001E == "1939-", 1939, B25035_001E),  # 替换 "1939-" 为 1939
           B25035_001E = ifelse(grepl("-", B25035_001E), NA, as.numeric(B25035_001E)), # 替换 "-" 为 NA 
           MYB_ages = year - B25035_001E) %>%
...
write.csv(merged_data, "../Data/Demographic_Nov16/merged_data.csv", row.names = FALSE)
